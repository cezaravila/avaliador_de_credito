package br.com.cezaravila.mscartoes.api.controller;

import br.com.cezaravila.mscartoes.api.dto.CartaoResponse;
import br.com.cezaravila.mscartoes.application.service.CartaoService;
import br.com.cezaravila.mscartoes.application.service.ClienteCartaoService;
import br.com.cezaravila.mscartoes.api.dto.CartaoSaveRequest;
import br.com.cezaravila.mscartoes.api.dto.CartoesPorClienteResponse;
...
public class CartoesController {
    ...
    public ResponseEntity cadastra(@RequestBody CartaoSaveRequest request) {
        Cartao cartao = request.toEntity();
    ...
    public ResponseEntity<List<CartaoResponse>> getCartoesRendaAteh(@RequestParam("renda") Long renda) {
        ...
        List<CartaoResponse> resp = list.stream().map(CartaoResponse::fromModel).collect(Collectors.toList());
